...
const ICONS = {
  ...
  // A SECOND sword, vertical where `sword` is diagonal: two-weapon fighting
  // needs two blade marks that stay apart at 10px.
  "sword2": "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M12 3.2 14 6.4v7.1h-4V6.4Z\"/><path d=\"M7.5 13.5h9M12 13.5v5M10.3 18.5h3.4\"/></svg>",
  // Shorter blade than `sword2`, narrower guard, round pommel — the pommel is
  // what keeps the two readable apart once they're chip-sized.
  "dagger": "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M12 4 13.6 7.4v5.4h-3.2V7.4Z\"/><path d=\"M9.2 12.8h5.6M12 12.8v3.4\"/><circle cx=\"12\" cy=\"17.6\" r=\"1.4\"/></svg>",
  // The arrow is deliberately lighter than the limb (1 / 0.5 against the set's
  // 1.5). Kept as presentation attributes rather than the source's inline
  // `style`: react-native-svg parses these for certain, a CSS string not.
  "bow": "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"m 9.2152542,4.6542373 a 10.5,10.5 0 0 1 0,14.7999997\"/><path d=\"M 9.2152542,4.6542373 V 19.454237\"/><path d=\"M 5.7152542,12.054237 H 15.715254\" stroke-width=\"1\"/><path d=\"m 14.34095,10.668733 2.018619,1.388794 -2.018619,1.388793\" stroke-width=\"0.504835\"/></svg>",
  // Same weighting as `bow`: the bolt is lighter than the limbs. Source `style`
  // rules become presentation attributes here — react-native-svg parses those
  // for certain, a CSS string not.
  "crossbow": "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M4.8 8.6a8.5 8.5 0 0 1 14.4 0\"/><path d=\"M4.8 8.6h14.4\"/><path d=\"M12 2v13.8\" stroke-width=\"1\"/><path d=\"M12 13h2.2\" stroke-width=\"1\"/><path d=\"M10.2 16h3.6\"/><path d=\"M 10.822431,2.797854 11.966075,0.84278494 13.109719,2.797854\" stroke-width=\"0.8\"/></svg>",
  "hand": "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M9.2 11.4V6.6a1.3 1.3 0 0 1 2.6 0v3.9\"/><path d=\"M11.8 10.5V5.5a1.3 1.3 0 0 1 2.6 0v5\"/><path d=\"M14.4 10.8V7.6a1.3 1.3 0 0 1 2.6 0V14a5.5 5.5 0 0 1-10.3 2.7L4.8 13.5a1.3 1.3 0 0 1 2.2-1.5l2.2 2.5\"/></svg>",
  ...
  "key": "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><circle cx=\"9\" cy=\"9\" r=\"4.5\"/><path d=\"M12.2 12.2 20 20\"/><path d=\"M16.4 16.4l-1.8 1.8\"/><path d=\"M18.2 18.2l-1.8 1.8\"/></svg>",
  ...
  "plusminus": "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.6\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M12 4v10M7 9h10M7 19h10\"/></svg>",
  "equals": "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.6\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M5 9.5h14M5 14.5h14\"/></svg>",
